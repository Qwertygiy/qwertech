...
public class Upgrade_Slime extends UpgradeBase {

	public Upgrade_Slime() {
	}
	...
	public IIcon getIcon(ItemStack aStack, int aRenderPass)
	{
		...
		return ((IIconContainer)RegisterArmor.iconTitle.get("qwertech:armor/" + slot + "/slime")).getIcon(aRenderPass);
	}
	...
	{
		aList.add(LH.Chat.ITALIC + LH.Chat.GRAY + "Slimy");
		return aList;
	}
