...
public class RegisterSpecies {
    ...
    public static void begin()
    {
        ...
        redJunglefowl.addTag(EGG_ITEM, QTI.junglefowlEgg.get(1)).addTag(EGG_COLOR, COLOR.make(205, 160, 140));
        ...
        greyJunglefowl.setPrimaryColors("Black",       "White")     .setSecondaryColors("Black",         "White")     .setCommonName("Grey Junglefowl")           .setLatinName("Gallus sonneratii")   .setMinFertility(2000)     .setMaxFertility(20000)   .setMinMaturity(8000)      .setMaxMaturity(20000)    .setMinMutable(10)      .setMaxMutable(1000)    .setMinSize(500)   .setMaxSize(2000)   .setMinSmart(100) .setMaxSmart(10000) .setMinSnarl(0) .setMaxSnarl(20000) .setMinStamina(1000) .setMaxStamina(16000)   .setMinStrength(1000)    .setMaxStrength(6000)   .setMeat(QTI.junglefowlWholeRaw.get(1))  .setSecondary(feather)   ;
        greyJunglefowl.addTag(EGG_ITEM, QTI.junglefowlEgg.get(1)).addTag(EGG_COLOR, COLOR.make(205, 160, 140));
        ...
        bbb.setPrimaryColors(COLOR.make(140, 90, 70), COLOR.make(130, 75, 55)).setSecondaryColors(COLOR.make(24, 32, 56), COLOR.make(30,75, 75)).setCommonName("Broad-breasted Bronze").setFertility(4000, 8000, 24000).setMaturity(8000, 12000, 20000).setMutable(10, 100, 1000).setSize(1000, 1100, 3000).setSmart(100, 5000, 10000).setSnarl(10, 15000, 20000).setStamina(1000, 3000, 6000).setStrength(1000, 4000, 8000).setTexturePath("qwertech:textures/entity/genetic/phasianidae/turkey_domestic/broadbronze").setLivingSound("qwertech:mob.turkey.say")  .setHurtSound("qwertech:mob.turkey.hurt")   .setDeathSound("qwertech:mob.turkey.death")   .addBiome(BiomeDictionary.Type.FOREST);
