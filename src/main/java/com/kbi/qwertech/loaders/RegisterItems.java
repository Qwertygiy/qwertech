...
public class RegisterItems {
	...
	public static void run()
	{
		...
		QTI.qwerFood.set(new MultiItemRandom(QwerTech.MODID, "qwertech.food") {@Override public void addItems() {
			addItem(0, "Mozzarella"					, "Itsa good cheese", 					new FoodStat(3, 0.5F, 0F, 310F, 0.1F, EnumAction.eat, null, false, false, false, false, new int[0]));
			addItem(1, "Raw Parmesan"				, "Needs to be soaked in saltwater", 	new FoodStat(1, 0.1F, 0F, 310F, 0.1F, EnumAction.eat, null, false, false, false, false, new int[0]));
			addItem(2, "Parmesan"					, "Ready for grating!", 				new FoodStat(3, 0.5F, -10F, 310F, 0.1F, EnumAction.eat, null, false, false, false, false, new int[0]));
			addItem(3, "Grated Parmesan"			, "Pasta perfection", 					new FoodStat(3, 0.5F, -10F, 310F, 0.1F, EnumAction.eat, null, false, false, false, false, new int[0]));
			addItem(4, "Flat Dough with Sauce"		, "For making Pizza",					new Object[] {});
			addItem(5, "Raw Turkey Breast"			, "",									"listAllmeatraw", "listAllturkeyraw", new FoodStat(3, 0.6F, 0.0F, 310.0F, 0.1F, 0, 0, 0, 0, 12, EnumAction.eat, null, false, true, false, true, new int[]{Potion.hunger.id, 1000, 1, 20}));
			addItem(6, "Cooked Turkey Breast"		, "",									"listAllmeatcooked", "listAllturkeycooked", new FoodStat(6, 0.6F, 0.0F, 311.0F, 0.5F, 0, 0, 0, 0, 12, EnumAction.eat, null, false, true, false, true, new int[0]));
			addItem(7, "Raw Turkey Leg" 			, "",									"listAllmeatraw", "listAllturkeyraw", new FoodStat(3, 0.6F, 0.0F, 310.0F, 0.1F, 0, 0, 0, 0, 3, EnumAction.eat, null, false, true, false, true, new int[]{Potion.hunger.id, 1000, 1, 20}));
			addItem(8, "Cooked Turkey Leg"			, "",									"listAllmeatcooked", "listAllturkeycooked", new FoodStat(8, 0.6F, 0.0F, 311.0F, 0.5F, 0, 0, 0, 0, 3, EnumAction.eat, null, false, true, false, true, new int[0]));
			addItem(9, "Raw Chicken Wing"			, "",									"listAllmeatraw", "listAllchickenraw", new FoodStat(2, 0.6F, 0.0F, 310.0F, 0.1F, 0, 0, 0, 0, 5, EnumAction.eat, null, false, true, false, true, new int[]{Potion.hunger.id, 1000, 1, 20}));
			addItem(10, "Cooked Chicken Wing"		, "",									"listAllmeatcooked", "listAllchickencooked", new FoodStat(5, 0.6F, 0.0F, 311.0F, 0.5F, 0, 0, 0, 0, 5, EnumAction.eat, null, false, true, false, true, new int[0]));
			addItem(11, "Raw Turkey Wing"			, "",									"listAllmeatraw", "listAllturkeyraw", new FoodStat(2, 0.6F, 0.0F, 310.0F, 0.1F, 0, 0, 0, 0, 3, EnumAction.eat, null, false, true, false, true, new int[]{Potion.hunger.id, 1000, 1, 20}));
			addItem(12, "Cooked Turkey Wing"		, "",									"listAllmeatcooked", "listAllturkeycooked", new FoodStat(5, 0.6F, 0.0F, 311.0F, 0.5F, 0, 0, 0, 0, 3, EnumAction.eat, null, false, true, false, true, new int[0]));
			addItem(13, "Turkey Egg"				, "",									"listAllegg", new Behavior_ThrowEgg());
			addItem(14, "Hard-Boiled Turkey Egg"	, "",									"foodBoiledegg", new FoodStat(5, 0.6F, 0.0F, 311.0F, 0.5F, 0, 0, 0, 0, 10, EnumAction.eat, null, false, true, false, true, new int[0]));
			addItem(15, "Hard-Boiled Egg"			, "",									"foodBoiledegg", new FoodStat(4, 0.6F, 0.0F, 311.0F, 0.5F, 0, 0, 0, 0, 5, EnumAction.eat, null, false, true, false, true, new int[0]));
			addItem(16, "Raw Chicken Leg"			, "",									"listAllmeatraw", "listAllchickenraw", new FoodStat(2, 0.6F, 0.0F, 310.0F, 0.1F, 0, 0, 0, 0, 5, EnumAction.eat, null, false, true, false, true, new int[]{Potion.hunger.id, 1000, 1, 20}));
			addItem(17, "Cooked Chicken Leg"		, "",									"listAllmeatcooked", "listAllchickencooked", new FoodStat(6, 0.6F, 0.0F, 311.0F, 0.5F, 0, 0, 0, 0, 12, EnumAction.eat, null, false, true, false, true, new int[0]));
			addItem(18, "Fried Chicken Leg"			, "",									"listAllmeatcooked", "listAllchickencooked", new FoodStat(6, 0.6F, 0.0F, 311.0F, 0.5F, 0, 0, 0, 0, 30, EnumAction.eat, null, false, true, false, true, new int[0]));
			addItem(19, "Fried Turkey Leg"			, "",									"listAllmeatcooked", "listAllturkeycooked", new FoodStat(8, 0.6F, 0.0F, 311.0F, 0.5F, 0, 0, 0, 0, 30, EnumAction.eat, null, false, true, false, true, new int[0]));
			addItem(20, "Fried Chicken Wing"		, "",									"listAllmeatcooked", "listAllchickencooked", new FoodStat(6, 0.6F, 0.0F, 311.0F, 0.5F, 0, 0, 0, 0, 30, EnumAction.eat, null, false, true, false, true, new int[0]));
			addItem(21, "Fried Turkey Wing"			, "",									"listAllmeatcooked", "listAllturkeycooked", new FoodStat(6, 0.6F, 0.0F, 311.0F, 0.5F, 0, 0, 0, 0, 30, EnumAction.eat, null, false, true, false, true, new int[0]));
			...
			addItem(25, "Raw Chicken Breast"		, "",									"listAllmeatraw", "listAllchickenraw", new FoodStat(3, 0.6F, 0.0F, 310.0F, 0.1F, 0, 0, 0, 0, 16, EnumAction.eat, null, false, true, false, true, new int[]{Potion.hunger.id, 1000, 1, 20}));
			addItem(26, "Cooked Chicken Breast"		, "",									"listAllmeatcooked", "listAllchickencooked", new FoodStat(5, 0.6F, 0.0F, 311.0F, 0.5F, 0, 0, 0, 0, 12, EnumAction.eat, null, false, true, false, true, new int[0]));
			addItem(27, "Whole Raw Chicken"			, "Too big to eat",						"carcassChicken");
			addItem(28, "Whole Cooked Chicken"		, "Too big to eat",						"carcassTurkey");
			addItem(29, "Raw Frog Leg"				, "Le slimey",							"listAllmeatraw", "listAllfrograw", new FoodStat(2, 0.5F, 0.0F, 310.0F, 0.1F, 0, 0, 3, 0, 4, EnumAction.eat, null, false, true, false, true, new int[]{Potion.hunger.id, 1000, 1, 20, Potion.confusion.id, 500, 1, 50}));
			addItem(30, "Cooked Frog Leg"			, "Lucky ribbit foot",					"listAllmeatcooked", "listAllfrogcooked", new FoodStat(5, 0.6F, 0.0F, 311.0F, 0.5F, 0, 0, 3, 0, 4, EnumAction.eat, null, false, true, false, true, new int[]{Potion.confusion.id, 100, 1, 10, Potion.jump.id, 1000, 1, 10}));
			addItem(31, "Frog Eggs"					, "Just add water",						"foodCaviar");
			addItem(1000, "Tomato Sauce"			, "", 									new Object[] {UT.Fluids.make("tomatosauce", 250L), FoodStatFluid.INSTANCE });
			addItem(1001, "Salsa"					, "Mild", 								new Object[] {UT.Fluids.make("mildsalsa", 250L), FoodStatFluid.INSTANCE });
			addItem(1002, "Salsa"					, "Medium", 							new Object[] {UT.Fluids.make("salsa", 250L), FoodStatFluid.INSTANCE });
			addItem(1003, "Salsa"					, "Magmatic", 							new Object[] {UT.Fluids.make("hotsalsa", 250L), FoodStatFluid.INSTANCE });
