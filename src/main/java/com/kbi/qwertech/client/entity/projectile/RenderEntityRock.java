...
import com.kbi.qwertech.client.models.ModelRock;
...
public class RenderEntityRock extends RenderEntity {
	
	protected ModelRock renderer;
	protected ModelRock overlay;
	
	public RenderEntityRock()
	{
		renderer = new ModelRock();
		overlay = new ModelRock();
	}
	
	public void renderRock(EntityRock entity, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
		GL11.glPushMatrix();
    	...
    	if (entity.getType() == 0) {
	    	GL11.glPushMatrix();
	    	this.bindTexture(new ResourceLocation("qwertech:textures/entity/rock/overlay.png"));
	        ...
	        overlay.render(entity, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0625F);
	    	GL11.glDisable(GL12.GL_RESCALE_NORMAL);
	    	GL11.glPopMatrix();
    	}
	}
	...
	{
		renderRock((EntityRock)entity, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
	}
