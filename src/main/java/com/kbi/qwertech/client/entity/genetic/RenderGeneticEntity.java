package com.kbi.qwertech.client.entity.genetic;
...
public class RenderGeneticEntity extends RenderLiving {

    //ResourceLocation texture = new ResourceLocation("qwertech:textures/entity/turkey.png");
    public RenderGeneticEntity(ModelBase model, float size) {
        super(model, size);
    }

    public void doRender(IGeneticMob p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
    {
    ...
    {
        return this.getEntityTexture((IGeneticMob)p_110775_1_);
    }
