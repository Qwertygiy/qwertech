...
public class QTMT {
	...
	ChemicalX = 	OreDictMaterial.createMaterial(13000, "ChemicalX", 		"Chemical X"		).setTextures(TextureSet.SET_PLASMA			).setRGBa(10, 	10, 	15, 	255	).heat(CS.C - 10, 	CS.C + 50										).aspects(TC.PRAECANTIO, 	2, 	TC.PERDITIO, 	1	).put(UNRECYCLABLE, 	LIQUID, 	CONTAINERS_FLUID,						FLAMMABLE, 	EXPLOSIVE									).setOriginalMod(MD.QT	).uumMcfg(0, 	MT.Magic, 	CS.U*2								),
	ChemicalY = 	OreDictMaterial.createMaterial(13001, "ChemicalY", 		"Chemical Y"		).setTextures(TextureSet.SET_PLASMA			).setRGBa(200, 	200, 	250, 	255	).heat(CS.C - 10, 	CS.C + 50										).aspects(TC.PRAECANTIO, 	2									).put(UNRECYCLABLE, 	LIQUID,	 	CONTAINERS_FLUID																				).setOriginalMod(MD.QT	).uumMcfg(0, 	ChemicalX, 	CS.U, 	MT.Magic, 	CS.U, 	MT.C, 	CS.U	),
	ChemicalZ = 	OreDictMaterial.createMaterial(13002, "ChemicalZ", 		"Chemical Z"		).setTextures(TextureSet.SET_LIGNITE		).setRGBa(50, 	50, 	75, 	255	).heat(CS.C + 49, 	CS.C + 50										).aspects(TC.PRAECANTIO, 	2									).put(UNRECYCLABLE,		FLAMMABLE,	GLOWING, 	INGOTS, 	INGOTS_HOT																).setOriginalMod(MD.QT	).uumMcfg(0, 	MT.Magic, 	CS.U, 	MT.C, 		CS.U					).addEnchantmentForTools(Enchantment_Radioactivity.INSTANCE, 1).addEnchantmentForArmors(Enchantment_Radioactivity.INSTANCE, 1),
	
	ChemicalY1 = 	OreDictMaterial.createMaterial(13003, "ChemicalY1",		"Chemical Y-1"		).setTextures(TextureSet.SET_FIERY			).setRGBa(120, 	120, 	140, 	255	).setWorking(MT.Ta, CS.U).setSmelting(MT.Ta, 	CS.U).setForging(MT.Ta, 	CS.U	).aspects(TC.PRAECANTIO, 	2,	TC.METALLUM,	1									).put(COATED,	G_INGOT_ND																											).setOriginalMod(MD.QT	).uumMcfg(0, 	ChemicalY,	CS.U,	MT.Ta,		CS.U					).qual(MT.Ta),
	ChemicalY2 = 	OreDictMaterial.createMaterial(13004, "ChemicalY2",		"Chemical Y-2"		).setTextures(TextureSet.SET_FIERY			).setRGBa(50, 	50, 	50, 	255	).setWorking(MT.W, CS.U).setSmelting(MT.W, 	CS.U).setForging(MT.W, 		CS.U	).aspects(TC.PRAECANTIO, 	2,	TC.METALLUM,	1									).put(COATED,	G_INGOT_ND																											).setOriginalMod(MD.QT	).uumMcfg(0, 	ChemicalY,	CS.U,	MT.W,		CS.U					).qual(MT.W),
	ChemicalY3 = 	OreDictMaterial.createMaterial(13005, "ChemicalY3",		"Chemical Y-3"		).setTextures(TextureSet.SET_FIERY			).setRGBa(255, 	255, 	200, 	255	).setWorking(MT.Re, CS.U).setSmelting(MT.Re, 	CS.U).setForging(MT.Re,		CS.U	).aspects(TC.PRAECANTIO, 	2,	TC.METALLUM,	1									).put(COATED,	G_INGOT_ND																											).setOriginalMod(MD.QT	).uumMcfg(0, 	ChemicalY,	CS.U,	MT.Re,		CS.U					).qual(MT.Re),
	ChemicalY4 = 	OreDictMaterial.createMaterial(13006, "ChemicalY4",		"Chemical Y-4"		).setTextures(TextureSet.SET_FIERY			).setRGBa(50, 	50, 	255, 	255	).setWorking(MT.Os, CS.U).setSmelting(MT.Os, 	CS.U).setForging(MT.Os, 	CS.U	).aspects(TC.PRAECANTIO, 	2,	TC.METALLUM,	1									).put(COATED,	G_INGOT_ND																											).setOriginalMod(MD.QT	).uumMcfg(0, 	ChemicalY,	CS.U,	MT.Os,		CS.U					).qual(MT.Os),
	ChemicalY5 = 	OreDictMaterial.createMaterial(13007, "ChemicalY5",		"Chemical Y-5"		).setTextures(TextureSet.SET_FIERY			).setRGBa(240, 	240, 	245, 	255	).setWorking(MT.Ir, CS.U).setSmelting(MT.Ir, 	CS.U).setForging(MT.Ir, 	CS.U	).aspects(TC.PRAECANTIO, 	2,	TC.METALLUM,	1									).put(COATED,	G_INGOT_ND																											).setOriginalMod(MD.QT	).uumMcfg(0, 	ChemicalY,	CS.U,	MT.Ir,		CS.U					).qual(MT.Ir),
	ChemicalY6 = 	OreDictMaterial.createMaterial(13008, "ChemicalY6",		"Chemical Y-6"		).setTextures(TextureSet.SET_FIERY			).setRGBa(100, 	180, 	250, 	255	).setWorking(MT.Pt, CS.U).setSmelting(MT.Pt, 	CS.U).setForging(MT.Pt, 	CS.U	).aspects(TC.PRAECANTIO, 	2,	TC.METALLUM,	1									).put(COATED,	G_INGOT_ND																											).setOriginalMod(MD.QT	).uumMcfg(0, 	ChemicalY,	CS.U,	MT.Pt,		CS.U					).qual(MT.Pt),
	ChemicalY7 = 	OreDictMaterial.createMaterial(13009, "ChemicalY7",		"Chemical Y-7"		).setTextures(TextureSet.SET_FIERY			).setRGBa(255, 	230, 	80, 	255	).setWorking(MT.Au, CS.U).setSmelting(MT.Au, 	CS.U).setForging(MT.Au, 	CS.U	).aspects(TC.PRAECANTIO, 	2,	TC.METALLUM,	1									).put(COATED,	G_INGOT_ND																											).setOriginalMod(MD.QT	).uumMcfg(0, 	ChemicalY,	CS.U,	MT.Au,		CS.U					).qual(MT.Au),
	ChemicalY8 = 	OreDictMaterial.createMaterial(13010, "ChemicalY8",		"Chemical Y-8"		).setTextures(TextureSet.SET_FIERY			).setRGBa(140, 	100, 	140, 	255	).setWorking(MT.Pb, CS.U).setSmelting(MT.Pb, 	CS.U).setForging(MT.Pb, 	CS.U	).aspects(TC.PRAECANTIO, 	2,	TC.METALLUM,	1									).put(COATED,	G_INGOT_ND																											).setOriginalMod(MD.QT	).uumMcfg(0, 	ChemicalY,	CS.U,	MT.Pb,		CS.U					).qual(MT.Pb),
	ChemicalY9 = 	OreDictMaterial.createMaterial(13011, "ChemicalY9",		"Chemical Y-9"		).setTextures(TextureSet.SET_FIERY			).setRGBa(50, 	240, 	50, 	255	).setWorking(MT.U_235, CS.U).setSmelting(MT.U_235, CS.U).setForging(MT.U_235, 	CS.U	).aspects(TC.PRAECANTIO, 	2,	TC.METALLUM,	1									).put(COATED,	G_INGOT_ND																											).setOriginalMod(MD.QT	).uumMcfg(0, 	ChemicalY,	CS.U,	MT.U_235,	CS.U					).qual(MT.U_235).addEnchantmentForTools(Enchantment_Radioactivity.INSTANCE, 1).addEnchantmentForArmors(Enchantment_Radioactivity.INSTANCE, 1),
